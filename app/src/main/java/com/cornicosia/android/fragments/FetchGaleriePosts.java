...
public class FetchGaleriePosts extends Fragment {
    ...
    private void fetchPostContent() {
        ...
        if (haveNetworkConnection()) {
            ...
            Ion.with(getActivity()).load("https://cor-nicosia.com/fetch-galerie-posts/")
                ...
                public void onCompleted(Exception e, JsonArray result) {
                    ...
                    if (result != null) {
                        ...
                        for (int i = 1; i < jsonArray.size(); i++) {
                            ...
                            String postPublishTime = "10:00 PM";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_fetch_galerie_posts, container, false);
