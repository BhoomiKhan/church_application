...
import com.cornicosia.android.Constants;
...
public class FetchArticolePosts extends Fragment {
    ...
    private void fetchPostContent() {
        ...
        if (haveNetworkConnection()) {
            ...
            Ion.with(getActivity()).load("https://cor-nicosia.com/fetch-articole-posts/")
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_fetch_articole_posts, container, false);
