...
public class FetchProgramPosts extends Fragment {
    ...
    private void fetchPostContent() {
        ...
        if (haveNetworkConnection()) {
            ...
            Ion.with(getActivity()).load("https://cor-nicosia.com/fetch-program-posts/")
                ...
                public void onCompleted(Exception e, JsonArray result) {
                    ...
                    if (result != null) {
                        ...
                        firstChildDate.setText(firstJSONObject.get("post_publish_date").getAsString()+"  "+" 10:00 PM");
                        ...
                        firstChildData.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                mIntent.putExtra("post_publish_time", "10:10 PM");
                                mIntent.putExtra("post_author", firstJSONObject.get("post_author").getAsString());
                                mIntent.putExtra("post_permalink", "https://www.google.com");
                        ...
                        for (int i = 1; i < jsonArray.size(); i++) {
                         ...
                         //   String postPermalink = jsonObject.get("post_permalink").getAsString();
                            postContentList.add(new PostContentModel(postTitle, postDescription, postPublishDate,postPublishTime, postAuthor, postImageLarge, postImageSmall,"Link to apply"));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_fetch_program_posts, container, false);
...
//                        Log.d("urlsis", postContentList.get(position).getUrl());
                        ...
                        mIntent.putExtra("post_publish_time", "01:10 PM");
